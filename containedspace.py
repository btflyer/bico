...
class ContainedSpace(object):
        ...
        def update(self,cycle_length): #private
            ...
            while True:
                try:
                    ...
                    time_passed = env.now - cycle_start_time
                    ...
                    print('Cycle interrupted at %s' % env.now)
        ...
        def current_heat_from_sources(self): #private
            total_output = sum(s.output for s in self.heat_sources)
